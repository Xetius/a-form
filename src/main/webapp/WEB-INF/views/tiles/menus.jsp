<div class="content">
    ...
    Golf Club where you can sample the food over a glass wine.</p>

    <p>For a sample menu click on the following link:</p>
    <a href="/downloads/sample-menu.pdf">Sample Menu</a>
</div>